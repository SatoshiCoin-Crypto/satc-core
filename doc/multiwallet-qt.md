...
In order to support loading of multiple wallets in satoshicoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is satoshicoin.cpp.
...
Changes to satoshicoin.cpp
----------------------
satoshicoin.cpp is the entry point into satoshicoin-qt, and as such, will require some minor modifications to provide hooks for

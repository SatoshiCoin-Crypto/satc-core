...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SatoshiCoin Core satoshicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  satoshicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded satoshicoin transaction") + "\n" +
                               "  satoshicoin-tx [options] -create [commands]   " + _("Create hex-encoded satoshicoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded satoshicoin transaction

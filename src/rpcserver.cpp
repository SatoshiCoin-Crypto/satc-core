...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SatoshiCoin features */
        {"satoshicoin", "masternode", &masternode, true, true, false},
        {"satoshicoin", "listmasternodes", &listmasternodes, true, true, false},
        {"satoshicoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"satoshicoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"satoshicoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"satoshicoin", "masternodedebug", &masternodedebug, true, true, false},
        {"satoshicoin", "startmasternode", &startmasternode, true, true, false},
        {"satoshicoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"satoshicoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"satoshicoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"satoshicoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"satoshicoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"satoshicoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"satoshicoin", "mnbudget", &mnbudget, true, true, false},
        {"satoshicoin", "preparebudget", &preparebudget, true, true, false},
        {"satoshicoin", "submitbudget", &submitbudget, true, true, false},
        {"satoshicoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"satoshicoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"satoshicoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"satoshicoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"satoshicoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"satoshicoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"satoshicoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"satoshicoin", "checkbudgets", &checkbudgets, true, true, false},
        {"satoshicoin", "mnsync", &mnsync, true, true, false},
        {"satoshicoin", "spork", &spork, true, true, false},
        {"satoshicoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"satoshicoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use satoshicoind, or the -server option to satoshicoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> satoshicoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:3888/\n";
}

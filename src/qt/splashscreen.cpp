...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("SatoshiCoin Core");
    QString versionText = QString(tr("Version v2.0.0-MAIN")).arg(QString::fromStdString(FormatFullVersion()));
    ...
    QString copyrightTextSatc = QChar(0xA9) + QString(tr(" 2018 The SatoshiCoin Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextSatc);

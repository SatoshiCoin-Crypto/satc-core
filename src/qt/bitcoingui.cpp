                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SatoshiCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SatoshiCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and satoshicoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SatoshiCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about SatoshiCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SatoshiCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SatoshiCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SatoshiCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a SatoshiCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SatoshiCoin Core help message to get a list with possible SatoshiCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SatoshiCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SatoshiCoin network", "", count));
}
...
{
    QString strTitle = tr("SatoshiCoin Core"); // default title

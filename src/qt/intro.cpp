...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SatoshiCoin Core"),
     ...
     * override -datadir in the satoshicoin.conf file in the default data directory
     * (to be consistent with satoshicoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())

...
/** Utility functions used by the SatoshiCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render SatoshiCoin addresses in monospace font
...
// Parse "satoshicoin:" URI into recipient object, return true on successful parsing

...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SATC);
    unitlist.append(mSATC);
    unitlist.append(uSATC);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case SATC:
        return QString("satoshicoin");
    case mSATC:
        return QString("msatoshicoin");
    case uSATC:
        return QString::fromUtf8("usatoshicoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case mSATC:
            return QString("Milli-TestSATC (1 / 1" THIN_SP_UTF8 "000)");
        case uSATC:
            return QString("Micro-TestSATC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
